        ...
        <div className="grid md:grid-cols-2 gap-8 items-center p-8 rounded-lg">
          <div className="grid gap-6 text-left">
            ...
            <p className="text-gray-100/80 text-lg">
              ...
              high-quality, affordable veterinary services to rescue groups and
              animal welfare organizations.
            </p>
            <div className="flex gap-4 py-2">
              <button className="bg-white/40 hover:bg-white hover:text-black text-slate-50 px-4 py-2 rounded">
                Learn More
              </button>
              <Link
                href="#"
                className="border border-white/30 px-4 py-2 rounded text-slate-50 hover:bg-white/80 hover:text-black transition-all ease-in-out"
              >
                Donate Now
              </Link>
            </div>
