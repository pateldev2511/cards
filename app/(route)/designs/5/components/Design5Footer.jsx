...
export default function Design5Footer() {
  return (
    <footer className="bg-blue-900 pt-12 text-white">
      <div className="container mx-auto px-4 md:px-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mb-4">
              Liberty Veterans Foundation is a 501(c)(3) organization dedicated
              to providing comprehensive health care and wellness services to
      ...
      <div className="text-center mt-8 border-t py-4 text-sm bg-blue-900 flex flex-col md:flex-row justify-center items-center">
