  ...
  return (
    <header className="bg-slate-50 text-primary-foreground py-8 px-6 z-10 relative">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex gap-8 ml-auto text-blue-600">
          <ul className="flex gap-8 ml-auto text-lg">
            {Menu.map((menuItem) => (
              <li
                key={menuItem.id}
                className="hover:font-medium hover:cursor-pointer transition-all ease-in-out list-none"
              >
        ...
        <div
          className={`fixed inset-0 bg-slate-100 backdrop-blur-md p-8 md:hidden flex flex-col justify-between ${
