// BlurShinyBackground.jsx
import React from "react";
import { motion } from "framer-motion";
import { cn } from "@/lib/utils";

const BlurShinyBackground = React.memo(({ className }) => {
  return (
    <div
      className={cn(
        "absolute inset-0 h-full w-full overflow-hidden z-[-1]",
        className
      )}
    >
      <svg
...
export default BlurShinyBackground;