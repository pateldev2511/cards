    ...
    <nav className="relative bg-black shadow p-3 z-50 ">
      <div className="container px-6 py-3 mx-auto flex justify-between items-center">
        ...
        <div className="hidden lg:flex lg:items-center lg:justify-between w-full lg:w-auto">
          <div className="flex flex-col lg:flex-row items-center lg:space-x-4">
            <Link
              href="/about"
              className="px-2.5 py-2 text-gray-200 duration-300 transform hover:scale-105 lg:mx-2 transition-all ease-in-out"
            >
              About
            </Link>
            <Link
            ...
            <Link
              href="/"
              className="flex p-3 text-gray-200 duration-300 transform hover:scale-105 lg:mx-2 items-center justify-center rounded-full border border-zinc-900 bg-zinc-950 transition-all ease-in-out"
            >
      ...
      >
        ...
        <div className="flex flex-col items-start mt-10 pl-8 space-y-6">
          <Link
            href="/"
            className="text-gray-200 transition-colors duration-300 transform hover:scale-105 hover:text-gray-100 flex items-center"
            onClick={() => setIsOpen(false)}
          >
